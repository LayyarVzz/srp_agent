...
即以 HTTP 运行。配置经本地 `LarkMCPRuntimeSettings` 读取，**不依赖根 settings.py /
agent 框架**，可独立打包部署（见 services/lark_mcp/README.md）。
"""

from __future__ import annotations

from services.lark_mcp.config import (
    LarkMCPRuntimeSettings,
    build_run_params,
    configure_logging,
)
